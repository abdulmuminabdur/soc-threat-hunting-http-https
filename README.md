...
![Initial Detection](https://github.com/abdulmuminabdur/soc-http-https-scanning-threat-hunt/blob/main/1st.png?raw=true)
...
![IP Analysis](https://github.com/abdulmuminabdur/soc-http-https-scanning-threat-hunt/blob/main/Screenshot%202025-12-28%20220217.png?raw=true)
![IP Analysis Continued](https://github.com/abdulmuminabdur/soc-http-https-scanning-threat-hunt/blob/main/Screenshot%202025-12-28%20220443.png?raw=true)
...
![Duration and Scope](https://github.com/abdulmuminabdur/soc-http-https-scanning-threat-hunt/blob/main/actual-ip-screenshot.png?raw=true)
...
## Summary
This investigation identified and contained automated reconnaissance activity without business impact. The case demonstrates effective use of Defender Advanced Hunting, KQL-based analysis, evidence-driven assessment, and appropriate SOC response actions.
